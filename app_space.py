    ...
    try:
        ...
        if msr_original:
            ...
            workflow = _inject_params(
                ...
                custom1_lora_strength=custom1_lora_strength,
                custom2_lora_strength=custom2_lora_strength,
                custom3_lora_strength=custom3_lora_strength,
                custom4_lora_strength=custom4_lora_strength,
                custom5_lora_strength=custom5_lora_strength,
                custom6_lora_strength=custom6_lora_strength,
                custom1_audio_strength=custom1_audio_strength,
                custom2_audio_strength=custom2_audio_strength,
                custom3_audio_strength=custom3_audio_strength,
                custom4_audio_strength=custom4_audio_strength,
                custom5_audio_strength=custom5_audio_strength,
                custom6_audio_strength=custom6_audio_strength,
                custom1_lora_file=custom1_lora_file,
                custom2_lora_file=custom2_lora_file,
                custom3_lora_file=custom3_lora_file,
                custom4_lora_file=custom4_lora_file,
                custom5_lora_file=custom5_lora_file,
                custom6_lora_file=custom6_lora_file,
            )
